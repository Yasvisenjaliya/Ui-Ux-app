...
const Navbar = ({ activeSection, onClose }) => {
  ...
  return (
    <div className="fixed m-16 w-[68%] bg-back dark:bg-gray-800 justify-center rounded-2xl">
      <div className="flex justify-center space-x-4 p-4 rounded-2xl bg-nav dark:bg-gray-800 border-b-2 border-b-black">
