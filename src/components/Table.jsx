  ...
  return (
    <div className="rounded-3xl">
      <table className="min-w-full overflow-x-auto bg-slate-200 dark:bg-gray-800 rounded-3xl shadow-md overflow-hidden">
        <thead className="sticky bg-[#8cceee] dark:bg-gray-700 border-b top-0">
        ...
        <tbody className="text-black dark:text-gray-400">
          {data.map((item, index) => (
            <tr
              key={index}
            ...
            >
              ...
              <td className="py-3 px-6 text-left">{item.active ? 'inactive' : 'Active'}</td>
